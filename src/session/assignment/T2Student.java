...
public class T2Student {
	...
	public T2Student(int thestid, String thename, String thecourse, int themarks) {
		super();
		this.stid = thestid;
		this.name = thename;
	...
	public void show() {
		...
		if (T2Student.course=="BCA"&&T2Student.marks>60) {
		 System.out.println("Student Id:"+stid+"Student Name:"+name+"Course:" + course + "Marks :" + marks);
		}
	}
...
//	    s5.show();
		...
		for (i = 0; i < n; i++) {
		 ...
		 thecourse = sc1.next();
			...
			st[i] = new T2Student(thestid, thename, thecourse, themarks);
			// st[i].show();
		}
