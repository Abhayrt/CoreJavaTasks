...
public class T8TrainersList {

public static void main(String[] args) {
		
		ArrayList<Trainee> trainer=new ArrayList<Trainee>();
		trainer.add(new Trainee(101,"abitha","java",22000));
		trainer.add(new Trainee(102,"abhay","java",10000));
		trainer.add(new Trainee(103,"samadhan","php",24000));
		trainer.add(new Trainee(104,"Harjyot","java",23000));
		trainer.add(new Trainee(103,"rohan","java",21000));
